...
I am a Software Engineer with 4 years of experience developing and optimizing distributed backend systems using Java, C#, Python, and cloud infrastructure.

At ServiceNow, I work on Java/Spring Boot microservices, asynchronous Kafka-based orchestration, secure enterprise APIs, observability, and production-ready AI systems including RAG pipelines and anomaly detection services.

My work spans AWS, Docker, Kubernetes, Terraform, PostgreSQL, Redis, OAuth 2.0, RBAC, OpenTelemetry, Prometheus, and Grafana.

I am currently focused on scalable backend systems, cloud-native infrastructure, distributed systems reliability, and applied AI/ML integrations.

---

## Technical Skills

My core stack spans backend systems, cloud infrastructure, distributed messaging, observability, and AI/ML-enabled applications.

<p align="center">
  <img src="https://skillicons.dev/icons?i=java,python,cs,js,ts,spring,nodejs,react,aws,docker,kubernetes,terraform,postgres,redis,kafka" />
</p>

| Category | Skills |
|---|---|
| Languages | Java, Python, C#, JavaScript, TypeScript, SQL, HTML/CSS |
| Backend | Spring Boot, Spring Security, .NET Core, Node.js, REST, GraphQL, gRPC |
| Cloud & Infrastructure | AWS ECS, AWS EKS, CloudFront, IAM, Docker, Kubernetes, Helm, Terraform |
| Data & Caching | PostgreSQL, Redis, Microsoft SQL Server |
| AI/ML | Scikit-learn, Pandas, NumPy, Elasticsearch Vector Search, RAG pipelines, LLM API Integration |
| DevOps & Observability | GitHub Actions, OpenTelemetry, Prometheus, Grafana, Git |
| Security | OAuth 2.0, JWT, RBAC, AES-256 Encryption |
| Methodologies | Agile/Scrum, CI/CD, Architecture Decision Records |
...
Built a cloud-connected smart lighting system using Raspberry Pi, LDR, and PIR sensors to reduce energy consumption by 30% through motion-activated and adaptive brightness controls.
...
Developed an NLP-based grammar correction tool using T5 and BERT, achieving 93% accuracy on benchmark datasets.
...
Developed a secure file-transfer module using C# and .NET Core with AES-256 encryption and optimized chunked data streaming.
...
Co-developed a Python-based anomaly detection microservice using scikit-learn and integrated it with backend Java services through gRPC endpoints.
...
### **Arizona State University** — *Master’s in Information Technology*  
**May 2025 | USA**

---

### **Pandit Deendayal Energy University** — *Bachelor of Technology in Computer Science and Engineering*  
**May 2023 | India**
...
### **IoT-Assisted Mushroom Cultivation in an Agile Environment**
